          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mb-12 animate-fade-in delay-400">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                {['AI-Native', 'Hyper-Personalized', 'Future-Ready', 'Ethical'].map((feature) => (
                  <span 
                    key={feature}
                    className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white text-sm font-bold"
                  >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in delay-600">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white/30 bg-dark blue text-white hover:bg-white/10 font-lexend rounded-full font-semibold px-8 py-4 text-lg backdrop-blur-sm"
                onClick={() => navigate('/coming-soon')}
              >
                Explore Platform
              </Button>
